...
db.collection('users').add({'name': "Dhruv Patel", 'email': "maanvp@uci.edu", 'weight': 135, 'height': 70, 'distance': 0, 'Kcal': 0, 'steps':0})
db.collection('users').add({'name': "Maan Patel", 'email': "maanvp@uci.edu", 'weight': 160, 'height': 72, 'distance': 0, 'Kcal': 0, 'steps':0})
